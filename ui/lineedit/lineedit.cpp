    ...
    : QLineEdit(parent)
{
    ...
    QIcon icon = QIcon::fromTheme("edit-delete.png", QIcon(":/"));
    ...
    connect(clearBtn, &QToolButton::clicked, this, &EnchancedLineEdit::clear );
    connect(this, &EnchancedLineEdit::textChanged,
            this, &EnchancedLineEdit::updateCloseButton);
    ...
    setMinimumSize(qMax(msz.width(),
                        clearBtn->sizeHint().height() + frameWidth * 2 + 2),
